...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 text-white sm:items-center py-4 sm:pt-0">
            ...
            @endif
            <div class="container border rounded col-3 offset-4">
                <h1>Registration</h1>
                <form method="POST" action="{{ route('user.registration') }}">
                    @csrf
                    <div class="form-group">
                        <label for="name" class="col-form-label-lg">Name</label>
                        <input class="form-control" id="name" name="name" type="text" value="" placeholder="Username">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="email" name="email" type="text" value="" placeholder="example@gmail.com">
                        @error('email')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <button class="btn btn-lg btn-primary" type="submit" name="registerBtn">Register</button>
                    </div>
                </form>
            </div>
        </div>
